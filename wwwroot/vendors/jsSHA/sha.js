...
!function (n, r) {
    ...
    var n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
        r = "ARRAYBUFFER not supported by this environment", t = "UINT8ARRAY not supported by this environment";
                ...
                return function (n, r, t) {
                    return function (n, r, t, e, i) {
                        ...
                        if ("UTF8" === r) for (h = -1 === i ? 3 : 0, f = 0; f < n.length; f += 1) for (u = [], 128 > (o = n.charCodeAt(f)) ? u.push(o) : 2048 > o ? (u.push(192 | o >>> 6), u.push(128 | 63 & o)) : 55296 > o || 57344 <= o ? u.push(224 | o >>> 12, 128 | o >>> 6 & 63, 128 | 63 & o) : (f += 1, o = 65536 + ((1023 & o) << 10 | 1023 & n.charCodeAt(f)), u.push(240 | o >>> 18, 128 | o >>> 12 & 63, 128 | o >>> 6 & 63, 128 | 63 & o)), w = 0; w < u.length; w += 1) {
                            for (s = (a = v + l) >>> 2; A.length <= s;) A.push(0);
                            A[s] |= u[w] << 8 * (h + i * (a % 4)), v += 1
                        } else for (h = -1 === i ? 2 : 0, c = "UTF16LE" === r && 1 !== i || "UTF16LE" !== r && 1 === i, f = 0; f < n.length; f += 1) {
                            for (o = n.charCodeAt(f), !0 === c && (o = (w = 255 & o) << 8 | o >>> 8), s = (a = v + l) >>> 2; A.length <= s;) A.push(0);
                            A[s] |= o << 8 * (h + i * (a % 4)), v += 2
                        }
            ...
            case"B64":
                return function (r, t, e) {
                    return function (r, t, e, i) {
                        var o, u, f, w, s, a, h = 0, c = t || [0], v = (e = e || 0) >>> 3, A = -1 === i ? 3 : 0,
                            l = r.indexOf("=");
            ...
            case"HEX":
                return function (n) {
                    return function (n, r, t, e) {
                        ...
                        for (i = 0; i < w; i += 1) o = n[i >>> 2] >>> 8 * (s + t * (i % 4)), f += u.charAt(o >>> 4 & 15) + u.charAt(15 & o);
    ...
    var u = 4294967296,
        ...
        a = "Chosen SHA variant is not supported", h = "Cannot set numRounds with MAC";
    ...
    function c(n, r) {
        ...
        if (i % 4 != 0) {
            ...
            return (n.value.length << 2) - 4 >= o + i && n.value.pop(), {value: n.value, binLen: n.binLen + r.binLen}
        }
        return {value: n.value.concat(r.value), binLen: n.binLen + r.binLen}
    }

    function v(n) {
        var r = {outputUpper: !1, b64Pad: "=", outputLen: -1}, t = n || {}, e = "Output length must be a multiple of 8";
    ...
    var l = function () {
        function n(n, r, t) {
            ...
            this.o = n, this.u = [], this.h = 0, this.v = !1, this.A = 0, this.l = !1, this.H = [], this.S = []
        }
        ...
        return n.prototype.update = function (n) {
            ...
            this.A += t, this.u = u.slice(t >>> 5), this.h = o % this.p, this.v = !0
            ...
            for (r = 0; r <= e; r += 1) this.H[r] = 909522486 ^ n.value[r], this.S[r] = 1549556828 ^ n.value[r];
            ...
            return n = this.R(this.S, this.B(this.o)), n = this.g(r, this.T, this.p, n, this.T)
        }, n
    }(), E = function (n, r) {
    ...
    function L(n, r) {
        var t, e, i, o, u, f, w, s = [];
        for (t = r[0], e = r[1], i = r[2], o = r[3], u = r[4], w = 0; w < 80; w += 1) s[w] = w < 16 ? n[w] : H(s[w - 3] ^ s[w - 8] ^ s[w - 14] ^ s[w - 16], 1), f = w < 20 ? C(H(t, 5), y(e, i, o), u, 1518500249, s[w]) : w < 40 ? C(H(t, 5), p(e, i, o), u, 1859775393, s[w]) : w < 60 ? C(H(t, 5), m(e, i, o), u, 2400959708, s[w]) : C(H(t, 5), p(e, i, o), u, 3395469782, s[w]), u = o, o = i, i = H(e, 30), e = t, t = f;
    ...
    function N(n, r) {
        ...
        for (t = r[0], e = r[1], i = r[2], o = r[3], u = r[4], w = r[5], s = r[6], a = r[7], v = 0; v < 64; v += 1) l[v] = v < 16 ? n[v] : T(S(A = l[v - 2], 17) ^ S(A, 19) ^ d(A, 10), l[v - 7], F(l[v - 15]), l[v - 16]), h = C(a, K(u), y(u, w, s), f[v], l[v]), c = R(U(t), m(t, e, i)), a = s, s = w, w = u, u = R(o, h), o = i, i = e, e = t, t = R(h, c);
        return r[0] = R(t, r[0]), r[1] = R(e, r[1]), r[2] = R(i, r[2]), r[3] = R(o, r[3]), r[4] = R(u, r[4]), r[5] = R(w, r[5]), r[6] = R(s, r[6]), r[7] = R(a, r[7]), r
    }
    ...
    var I = function (n) {
        function r(r, t, e) {
            ...
            return (o = n.call(this, r, t, e) || this).K = o.N, o.k = !0, o.F = -1, o.m = i(o.t, o.i, o.F), o.R = N, o.L = function (n) {
                ...
                return function (n, r, t, e, i) {
                    for (var o, f = 15 + (r + 65 >>> 9 << 4), w = r + t; n.length <= f;) n.push(0);
                    for (n[r >>> 5] |= 128 << 24 - r % 32, n[f] = 4294967295 & w, n[f - 1] = w / u | 0, o = 0; o < n.length; o += 16) e = N(n.slice(o, o + 16), e);
    ...
    function x(n) {
        var r = z(n, 28), t = z(n, 34), e = z(n, 39);
    ...
    function D(n) {
        var r = z(n, 1), t = z(n, 8), e = O(n, 7);
        return new M(r.I ^ t.I ^ e.I, r.M ^ t.M ^ e.M)
    }

    function G(n) {
        var r = z(n, 14), t = z(n, 18), e = z(n, 41);
        return new M(r.I ^ t.I ^ e.I, r.M ^ t.M ^ e.M)
    }
    ...
    function W(n, r) {
        ...
        for (t = r[0], e = r[1], i = r[2], o = r[3], u = r[4], f = r[5], w = r[6], s = r[7], c = 0; c < 80; c += 1) c < 16 ? (v = 2 * c, H[c] = new M(n[v], n[v + 1])) : H[c] = V((A = H[c - 2], l = void 0, E = void 0, b = void 0, l = z(A, 19), E = z(A, 61), b = O(A, 6), new M(l.I ^ E.I ^ b.I, l.M ^ E.M ^ b.M)), H[c - 7], D(H[c - 15]), H[c - 16]), a = Z(s, G(u), j(u, f, w), J[c], H[c]), h = P(x(t), _(t, e, i)), s = w, w = f, f = u, u = P(o, a), o = i, i = e, e = t, t = P(a, h);
        return r[0] = P(t, r[0]), r[1] = P(e, r[1]), r[2] = P(i, r[2]), r[3] = P(o, r[3]), r[4] = P(u, r[4]), r[5] = P(f, r[5]), r[6] = P(w, r[6]), r[7] = P(s, r[7]), r
    }
    ...
    var $ = function (n) {
            function r(r, t, e) {
                ...
                return (o = n.call(this, r, t, e) || this).K = o.N, o.k = !0, o.F = -1, o.m = i(o.t, o.i, o.F), o.R = W, o.L = function (n) {
                    ...
                    return function (n, r, t, e, i) {
                        for (var o, f = 31 + (r + 129 >>> 10 << 5), w = r + t; n.length <= f;) n.push(0);
                        for (n[r >>> 5] |= 128 << 24 - r % 32, n[f] = 4294967295 & w, n[f - 1] = w / u | 0, o = 0; o < n.length; o += 32) e = W(n.slice(o, o + 32), e);
                        return "SHA-384" === i ? [(e = e)[0].I, e[0].M, e[1].I, e[1].M, e[2].I, e[2].M, e[3].I, e[3].M, e[4].I, e[4].M, e[5].I, e[5].M] : [e[0].I, e[0].M, e[1].I, e[1].M, e[2].I, e[2].M, e[3].I, e[3].M, e[4].I, e[4].M, e[5].I, e[5].M, e[6].I, e[6].M, e[7].I, e[7].M]
                    }(n, t, e, i, r)
    ...
    function on(n, r) {
        ...
        for (t = 0; t < 24; t += 1) {
            for (o = tn(), e = 0; e < 5; e += 1) h[e] = (u = r[e][0], f = r[e][1], w = r[e][2], s = r[e][3], a = r[e][4], new M(u.I ^ f.I ^ w.I ^ s.I ^ a.I, u.M ^ f.M ^ w.M ^ s.M ^ a.M));
    ...
    function un(n) {
        ...
        return e = 0 !== e ? e : 1, i[0] |= e, {value: e + 1 > 4 ? i : [i[0]], binLen: 8 + 8 * e}
    }
    ...
    var sn = function (n) {
        function r(r, t, e) {
            var o = this, u = 6, f = 0, w = e || {};
            if (1 !== (o = n.call(this, r, t, e) || this).numRounds) {
                if (w.kmacKey || w.hmacKey) throw new Error(h);
            ...
            return o.g = function (n, r, t, e, i) {
                return function (n, r, t, e, i, o, u) {
                    ...
                    for (n[(f = r >>> 3) >> 2] ^= o << f % 4 * 8, n[h - 1] ^= 2147483648, e = on(n, e); 32 * a.length < u && (w = e[s % 5][s / 5 | 0], a.push(w.M), !(32 * a.length >= u));) a.push(w.I), 0 == 64 * (s += 1) % i && (on(null, e), s = 0);
                    return a
                }(n, r, 0, e, f, u, i)
            }, w.hmacKey && o.Y(A("hmacKey", w.hmacKey, o.F)), o
        }
        ...
        return b(r, n), r.prototype.j = function (n, r) {
            var t = function (n) {
                ...
                return {
                    ...
                    customization: A("Customization", r.customization, 1, {value: [], binLen: 0})
                }
            }(n || {});
            r && (t.funcName = r);
            var e = c(fn(t.funcName), fn(t.customization));
            if (0 !== t.customization.binLen || 0 !== t.funcName.binLen) {
                for (var i = wn(e, this.p >>> 3), o = 0; o < i.length; o += this.p >>> 5) this.U = this.R(i.slice(o, o + (this.p >>> 5)), this.U), this.A += this.p;
                return 4
            }
            return 31
            ...
            this.j(n, r.funcName);
            for (var t = wn(fn(r.kmacKey), this.p >>> 3), e = 0; e < t.length; e += this.p >>> 5) this.U = this.R(t.slice(e, e + (this.p >>> 5)), this.U), this.A += this.p;
            this.l = !0
        }, r.prototype.O = function (n) {
            var r = c({value: this.u.slice(), binLen: this.h}, function (n) {
                var r, t, e = 0, i = [0, 0], o = [4294967295 & n, n / u & 2097151];
                for (r = 6; r >= 0; r--) 0 == (t = o[r >> 2] >>> 8 * r & 255) && 0 === e || (i[e >> 2] |= t << 8 * e, e += 1);
                return i[(e = 0 !== e ? e : 1) >> 2] |= e << 8 * e, {value: e + 1 > 4 ? i : [i[0]], binLen: 8 + 8 * e}
            }(n.outputLen));
